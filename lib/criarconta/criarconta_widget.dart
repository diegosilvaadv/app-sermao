...
class _CriarcontaWidgetState extends State<CriarcontaWidget>
  ...
  void initState() {
    ...
    _model.confirpasswordController ??= TextEditingController();
  }
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 12.0, 0.0, 24.0),
                              child: Text(
                                'Para ter acesso aos sermões e poder utilizar-los, precisa criar uma conta. Todas as suas informações estarão seguras.',
                                textAlign: TextAlign.center,
                            ...
                            Padding(
                              ...
                              child: Container(
                                width: double.infinity,
                                child: TextFormField(
                                  controller: _model.confirpasswordController,
                                  autofocus: true,
                                  autofillHints: [AutofillHints.password],
                                  obscureText: !_model.confirpasswordVisibility,
                                  decoration: InputDecoration(
                                  ...
                                  style: FlutterFlowTheme.of(context).bodyLarge,
                                  validator: _model
                                      .confirpasswordControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  if (_model.passwordController.text !=
                                      _model.confirpasswordController.text) {
